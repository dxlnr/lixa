          ...
          <div class="flex-none">
            <div class="flex flex-row">
              ...
              <form onSubmit={handleSubmit}>
                <input type="text" id="input-group-1" class="placeholder-slate-300 text-slate-600 relative bg-white bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring px-3 py-3 h-12 w-2/5" placeholder="prompt" value={prompt()} onInput={(e) => setPrompt(e.target.value)}/>
                </form>
            </div>
          </div>
          <div class="flex-none">
